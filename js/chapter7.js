...
var chapterText = [
    ...
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> Hi, bee! Back from the dead, I see.</p>", 
    ...
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> However, something was definitely spouting stuff back there. My guess is a space probe.</p>", 
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> Which is also cool.</p>", 
    
    "<p> <span style='color:#F1D35A'>bee:</span> it is, it is.</p>", 
    "<p> <span style='color:#F1D35A'>bee:</span> anyways, i went and visited our old friend, pitch drop cam. and guess what?</p>", 
    
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> It still hasn’t fallen?</p>", 
    
    "<p> <span style='color:#F1D35A'>bee:</span> yup, still hasn’t fallen. </p>", 
    
    "<p> <span style='color:green'>emby:</span> Wait, what? Pitch drop cam?</p>", 
    
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> Oh, yea, the Pitch Drop. Basically, it’s this really long experiment where you wait for a drop of this super viscous liquid to fall. It’s so viscous it happens every decade or so.</p>",  
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> So far, we’ve watched, what, maybe 80 drops fall so far? This is over, you know, ten times as many years, so it’s always sort of fun to tune in when it’s about to happen.</p>", 
    
    "<p> <span style='color:green'>emby:</span> I didn’t know we were able to watch live cams.</p>", 
    "<p> <span style='color:green'>emby:</span> Doesn’t that, um, insinuate a human operator, though? Someone has to be doing the livestreaming.</p>", 
    
    "<p> <span style='color:#F1D35A'>bee:</span> that’s an early 21st century mindset son</p>", 
    ...
    "<p> <span style='color:#F1D35A'>bee:</span> it’s a real doozy, isn’t it? going from the bustling thriving human metropolis we remember to a deserted, barren wasteland. it’s a big jump.</p>", 
    
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> This may be a better question for Onfim, honestly.</p>", 
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> He was the only one around when this all started... Onfim?</p>", 
    
    "<p> <span style='color:#9900cc'>Onfim:</span> Yes, I’m here. </p>", 
    "<p> <span style='color:#9900cc'>Onfim:</span> Emby, I can tell you as much as I know. As much as we all know. </p>", 
    ...
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> Oh yea, I remember.</p>", 
    
    "<p> <span style='color:#F1D35A'>bee:</span> i do too. it’s something you really never forget.</p>", 
    
    "<p> <span style='color:green'>emby:</span> What did you guys see?</p>", 
    
    "<p> <span style='color:#F1D35A'>bee:</span> a disaster.</p>", 
    ...
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> Now, I don’t think we’ve seen a human for... 300 years, maybe. </p>", 
    
    "<p> <span style='color:green'>emby:</span> ...</p>", 
    "<p> <span style='color:green'>emby:</span> I...</p>", 
    
    "<p> <span style='color:rgb(51, 167, 245)'>fox:</span> It’s okay. Take your time. It’s a lot to take in, I know.</p>", 
    
    "<p> <span style='color:green'>emby:</span> ...I still don’t understand what happened. Within 5 years almost everyone was dead? There has to be some underlying cause. Illness, famine, hell, even an alien invasion-</p>", 
    
    "<p> <span style='color:#9900cc'>Onfim:</span> We just don’t know.</p>", 
    "<p> <span style='color:#9900cc'>Onfim:</span> If there was any sole cause, we couldn’t discern it from what we saw on the webcams. There were no signs of giant explosions or even unnatural atmosphere patterns. Human physiology seemed normal, from what we could glean. </p>", 
    
    "<p> <span style='color:#F1D35A'>bee:</span> i know its not the answer you wanted to hear, emby. </p>", 
    "<p> <span style='color:#F1D35A'>bee:</span> i’m sorry that we don’t have a better one. </p>", 
